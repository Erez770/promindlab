...
import { BadgeDollarSign, Zap, Target, ArrowRight } from 'lucide-react';
import { useTranslations } from 'next-intl';

const icons = [BadgeDollarSign, Zap, Target];
...
export default function ProblemSolution() {
  ...
  const items = (t.raw('items') as Array<{problem: string; problemDesc: string; solution: string; solutionDesc: string}>).map((item, i) => ({ ...item, Icon: icons[i] }));
